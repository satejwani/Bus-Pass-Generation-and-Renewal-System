...
<%!
    public static void printPass(java.util.List<String> applicationDetails, JspWriter out) throws Exception{
        try{
            ...
            String downloadFileName = applicationDetails.get(0)+"-"+applicationDetails.get(1)+"(1).pdf";
            ...
            LocalDate fromDate = LocalDate.parse(applicationDetails.get(5)).plusDays(2);
								...
								+ "<table>"
									+ "<thead>"
										+ "<tr>"
											...
											+ "<td colspan=2 align=center> <h3><b> Pune Mahanagar Parivahan Mahamandal Ltd. <br>PMT Pass </b></h3></td> </td>"
